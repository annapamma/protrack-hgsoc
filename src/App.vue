<template>
  <v-app>
    ...
    <main class="main">
        ...
        <iprofun-container :style="showIprofun" view="Iprofun" />
...
import IprofunContainer from './components/IprofunContainer.vue';
...
export default {
  ...
  mounted() { this.$store.dispatch('sortSamples', { lockTracks: ['Tumor response', 'Protein cluster'] }) }
};
</script>
